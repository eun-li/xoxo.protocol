...
export default function App() {
          ...
          >
            <div className="space-y-2">
              <div className="flex gap-2 text-pink-soft/60">
                <span>[system]</span>
                <Typewriter 
                  text="Initializing xoxo.PR0TOCOL_v6.7..." 
                  delay={30} 
  ...
  {">"} Hello <span className="font-mono text-pink-soft/60">Lex</span>, One encrypted package found for you.
</p>Received!   
          ...
          >
            ...
            <div className="absolute bottom-8 center-0 text-[10px] font-mono text-pink-soft/60 uppercase tracking-widest">
                only ý̵̛̀ͅo̸̻̘͓͌̈̂̈́̆̔̀̓͠ṷ̴̪̥̙̤̳̜̥̝͒̓͆̽, lexi
            </div>
          </motion.div>
        )}
      </AnimatePresence>
